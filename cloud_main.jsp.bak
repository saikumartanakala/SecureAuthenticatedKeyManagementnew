      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="mainbar">
            <div class="article">
            <p></p>
            <h2><font color="red">Welcome ::</font> <%= application.getAttribute("cname")%></h2>
               <h2><font color="red">Cloud Type ::</font> Travel Server</h2>
              <p>&nbsp;</p>
              <p align="justify" class="style1"><img src="images/Capture.PNG" height="300" width="500"></p>
              <div class="clr">
                <p>&nbsp;</p>
                <p>&nbsp;</p>
              </div>
